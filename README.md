...
## Introduction
Phew, that was a long prerequisite :joy:. This will be an in-depth guide so *theoretically* you don't need to know all the things mentioned above in Pre-prerequisite but I want this to be a tutorial where you could learn why and how things work instead of just running around with a finished microcontroller not knowing how different components inside actually works.

So, why ATmega328? ~~Well, I actually had to make this for a class and so I already know how to do everything and just wanted to pass down this knowledge.~~ ATmega
